...
export const deleteNotification = (id: number) => {
    return async (dispatch: any, getState:any) => {
        ...
        usersRef.doc(uid).collection('notification').get()
        .then(snapshot => {
            const match:any = []
...
export const fetchNotification = () => {
    return async (dispatch:any, getState:any) => {
        ...
        usersRef.doc(uid).collection('notification').orderBy('release_date', 'asc')
...
export const fetchFolders = (uid:string) => {
    return async (dispatch:any) => {
        usersRef.doc(uid).collection('folder').orderBy('created_at', 'asc')
        .onSnapshot(snapshots => {
            const list:any = []
            snapshots.forEach((snapshot:any) => {
                const data = snapshot.data()
...
export const fetchFavoriteMovie = (uid:any) => {
    return async (dispatch:any) => {
        usersRef.doc(uid).collection("favorite").orderBy('timestamp', 'desc')
        .onSnapshot(snapshots => {
            const list:any = []
