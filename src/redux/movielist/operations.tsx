import {API_GET_MOVIE_POPULAR, API_KEY, API_KEY_ALT, API_PARAMS_GENRE, API_PARAMS_PAGE, URL, URL_LIST, URL_SEARCH, API_GET_MOVIE_SIMILAR} from '../../api';
import { fetchMovie, fetchMovieFailure, fetchMovieSuccess, searchMovie,searchMovieSuccess, searchMovieFailure } from './actions';
