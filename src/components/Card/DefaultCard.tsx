...
const DefaultCard: React.FC<Props> = ({info, path,id, title, voteAverage, release_date, voteCount, name, first_air_date}) => {
    ...
    return (
        <Div>
            ...
            onClick={() => dispatch(push('/movie/' + id))}
            >
                <CardActionArea>
                    <Img
                        src={path === null ? (NoImage):(URL_IMG+'w600_and_h900_bestv2'+path)}
                        alt={title}
                    />
